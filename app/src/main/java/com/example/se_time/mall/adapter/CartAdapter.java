...
//    }
    ...
    public void onBindViewHolder(final CartAdapter.CartViewHolder holder, final int position) {
        ...
        Glide.with(context).load(Constant.API.BASE_URL2+cartItem.getIconUrl()).into(holder.icon_url);

        System.out.println("cartItem icon_url:"+Constant.API.BASE_URL2+cartItem.getIconUrl());
